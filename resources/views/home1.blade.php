                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            ...
                            <p class="lead text-white-50 mb-4">Створіть замовлення в один клік після реєстрації на сайті!</p>
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                                <a class="btn btn-primary btn-lg px-4 me-sm-3" href="#">Зареєструватися</a>
                                <a class="btn btn-outline-light btn-lg px-4" href="#">Увійти</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-xl-3">
                        <div class="card mb-5 mb-xl-0">
                            <div class="card-body p-5">
                                <div class="mb-3">
                                    <span class="display-6 fw-bolder">01</span>
                                </div>
